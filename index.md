...
- perform an account lookup after clicking on the following link --> [account name lookup link](https://sdacs.ucsd.edu/~icc/index.php)
...
- open the program VScode (shown below) (if not already installed here is the link to do so --> [visual studio code link](https://code.visualstudio.com)
